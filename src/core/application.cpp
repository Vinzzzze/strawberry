 ...
 public:
  explicit ApplicationImpl(Application *app)
      : tagreader_client_([app]() {
        ...
        playlist_manager_([app]() { return new PlaylistManager(app->task_manager(), app->tagreader_client(), app->url_handlers(), app->playlist_backend(), app->collection_backend(), app->current_albumcover_loader(), GROUPED_BEFORE_QUEUE_DEFAULT); }),
