...
void SmartPlaylistSearchPreview::Init(const SharedPtr<Player> player,
  ...
  model_ = new Playlist(nullptr, nullptr, nullptr, collection_backend_, nullptr, -1, QString(), false, GROUPED_BEFORE_QUEUE_DEFAULT, REMOVE_DUPLICATES_DEFAULT, 0, 50, this);
