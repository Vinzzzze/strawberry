...
class Mpris2 : public QObject {
 ...
 public:
  ...
  Q_PROPERTY(QString ShuffleValue READ ShuffleValue WRITE SetShuffleValue)  // clazy:exclude=qproperty-without-notify
  ...
  Q_PROPERTY(Track_Ids LastPlayedTracks READ LastPlayedTracks)  // clazy:exclude=qproperty-without-notify
  ...
  QString ShuffleValue() const;
  void SetShuffleValue(const QString& value);
